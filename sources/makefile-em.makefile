...
clean:
  rm gamecenter.o hero.o cell.o monthday.o maptable.o mainwrapper.o ../postechbegins.out.js ../postechbegins.out.js.map

cleano:
  rm gamecenter.o hero.o cell.o monthday.o maptable.o mainwrapper.o
