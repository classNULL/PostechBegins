...
wstring march_event::check_success(hero* hero, const PersonalStatus& increased_status){
...
wstring april_event::check_success(hero* hero, const PersonalStatus& increased_status){
...
wstring may_event::check_success(hero* hero, const PersonalStatus& increased_status){
...
wstring june_event::check_success(hero* hero, const PersonalStatus& increased_status){
	if(increased_status.relationship > 60){ //식별자 정의 필요
		hero->up_event();
...
wstring september_event::check_success(hero* hero, const PersonalStatus& increased_status){
	if(increased_status.relationship > 60){ //식별자 정의 필요
		hero->up_event();
		return L"술은 많이 드셨나요?!";
	}
...
wstring october_event::check_success(hero* hero, const PersonalStatus& increased_status){
...
wstring november_event::check_success(hero* hero, const PersonalStatus& increased_status){
...
wstring december_event::check_success(hero* hero, const PersonalStatus& increased_status){
	if(increased_status.relationship > 60){ //식별자 정의 필요
		hero->up_event();
