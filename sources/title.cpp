...
TitleEffect Titles::outsider = { // 아싸
  ...
  .love = { .energy = 1, .love = 1, .relationship = 1.1, .self_develop = 1, .study = 1, .stress = 1 },
...
TitleEffect Titles::alcoholic = { // 술쟁이
  ...
  .love = { .energy = 1, .love = 1, .relationship = 1, .self_develop = 1, .study = 1, .stress = 1 },
  .rest = { .energy = 1, .love = 1, .relationship = 1, .self_develop = 1, .study = 1, .stress = 1 },
  .home = { .energy = 1, .love = 1, .relationship = 1, .self_develop = 1, .study = 1, .stress = 1 }
};
...
TitleEffect Titles::nerd = { // 공부벌레
  ...
  .love = { .energy = 1, .love = 1, .relationship = 0.95, .self_develop = 1, .study = 1.1, .stress = 0.95 },
...
TitleEffect Titles::couple = { // 연애중
  ...
  .love = { .energy = 1.1, .love = 1, .relationship = 0.9, .self_develop = 0, .study = 0.9, .stress = 0.9 },
...
TitleEffect Titles::circle_independent = { // 무동아리
  ...
  .love = { .energy = 1, .love = 1, .relationship = 0.9, .self_develop = 1, .study = 1, .stress = 1 },
...
TitleEffect Titles::weak = { // 체력낮음
  ...
  .circle = { .energy = 1, .love = 1, .relationship = 1, .self_develop = 1, .study = 1, .stress = 1 },
  .love = { .energy = 1, .love = 1, .relationship = 1, .self_develop = 1, .study = 1, .stress = 1 },
  .rest = { .energy = 1.1, .love = 1.1, .relationship = 1.1, .self_develop = 1.1, .study = 1.1, .stress = 1.1 },
  .home = { .energy = 1, .love = 1, .relationship = 1, .self_develop = 1, .study = 1, .stress = 1 }
};
